...
public class SwaggerConfig {
    ...
    private static final String AUTHOR_MAIL = "mohamed@gmail.com";
    private static final String API_TITLE = "Swagger API";
    private static final String API_DESCRIPTION = "Personal Sport Trackerz";
    private static final String API_BASE_PACKAGE = "com.developer.pst.personal_sport_trackerz";
